...
+ SCALE-UP: An Efficient Black-box Input-level Backdoor Detection via Analyzing Scaled Prediction Consistency [[paper](https://openreview.net/forum?id=o0LFPcoFKnr)] [[code](https://github.com/JunfengGo/SCALE-UP)]
...
+ Don’t forget the nullspace! Nullspace occupancy as a mechanism for out of distribution failure [[paper](https://openreview.net/forum?id=39z0zPZ0AvB)]
